...
public class UnrealTournament99 : SimpleTCPPack
{
    ...
    public override EffectList Effects { get; } = new Effect[]
    {
        ...
        new("Swap Two Players Positions", "swap_player_position"){Price = 10, Description = "2 players swap positions on the map!"},
        ...
        new("Thanos Snap", "thanos") { Category = "Health & Ammo", Price = 15, Description = "Each player has a 50% chance of instantly being killed!" },
